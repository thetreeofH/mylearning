...
public class OauthUser extends User implements UserDetails {
    ...
    public OauthUser(String id, String username, String password, String name, String departId, String isSuperAdmin, String tenantId, Collection<GrantedAuthority> authorities) {
        super(username, password, authorities);
        this.id = id;
        this.name = name;
        this.departId = departId;
