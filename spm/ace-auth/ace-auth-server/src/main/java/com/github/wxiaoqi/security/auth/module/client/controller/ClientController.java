...
public class ClientController{
    ...
    @RequestMapping(value = "/clientUserNum")
    public ObjectRestResponse getClientUserNum() {
        RedisTokenStore redisTokenStore = new RedisTokenStore(redisConnectionFactory);
        redisTokenStore.setPrefix("AG:OAUTH:");
        return new ObjectRestResponse().data(redisTokenStore.findTokensByClientId("vue").size());
    }
