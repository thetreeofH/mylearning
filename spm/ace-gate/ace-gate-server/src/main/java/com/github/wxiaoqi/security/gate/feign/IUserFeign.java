 ...
 */
@FeignClient(value = "spm-bizs",configuration = FeignConfiguration.class)
public interface IUserFeign {
   ...
   * @return
   */
  @GetMapping(value = "user/info/userinfoByUserid")
  public Map<String, Object> userinfoByUserid(@RequestParam("userId") String userId);
}
