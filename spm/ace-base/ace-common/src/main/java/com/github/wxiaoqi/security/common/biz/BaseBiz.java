...
public abstract class BaseBiz<M extends CommonMapper<T>, T> {
    ...
    public int delete2(T entity) {return mapper.delete(entity);}
    public int deleteById2(Object id) {
        return mapper.deleteByPrimaryKey(id);
    }
    public int updateById2(T entity) {
        return mapper.updateByPrimaryKey(entity);
    }
    public int updateSelectiveById2(T entity) {return mapper.updateByPrimaryKeySelective(entity); }
