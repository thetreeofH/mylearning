...
public interface GateLogMapper extends CommonMapper<GateLog> {
    List<GateLogVo>  allpage(@Param("begintime") String begintime, @Param("endtime") String endtime, @Param("crtName") String crtName, @Param("opt") String opt, @Param("addr") String addr, @Param("item") List<String> item);
}
