package com.ts.spm.bizs.tool.oss.util;
...
public class FTPUtils {
    ...
    public FTPUtils() {
        // 在控制台打印操作过程
        mFTPClient.addProtocolCommandListener(new PrintCommandListener(new PrintStream(System.out)));
    }
    ...
    public static boolean ftpDownload(String fileName, String ftpUrl, int ftpPort,
        ...
        try {
            ...
            if (isConnection) {
                ...
                System.out.println("链接ftp服务器失败，请检查配置信息是否正确！");
                result = false;
            }
    ...
    public static void main(String[] args) {
        boolean f=FTPUtils.ftpDownload("2577440d3d664a3ab500f8a4f5104c34.jpeg","10.16.100.14",21,"ftpuser","sx123456","/data/ftpdir/spm/da/437de90cf5014999ac396040db01a193/20201105/","D:/test");
