...
@Table(name = "TBL_INNER_CHECK")
public class TblInnerCheck {
    @Id
    ...
    @Transient
    private List<TblInnerCheckProblem> tblInnerCheckProblemList;
    ...
    public List<TblInnerCheckProblem> getTblInnerCheckProblemList() {
        return tblInnerCheckProblemList;
    }

    public void setTblInnerCheckProblemList(List<TblInnerCheckProblem> tblInnerCheckProblemList) {
