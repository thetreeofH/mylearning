...
public interface GroupMapper extends CommonMapper<Group> {
    ...
    List<Group> groupByuserid(@Param("userid") String userid);
    void deleteGroupLeadersByUserid(@Param("userid") String userid);

    //new
    List<Group> getUsersRole(@Param("userId") String userId, @Param("name") String name, @Param("status") String status);

    public int getUserByRoleId(@Param("roleId") String roleId);
