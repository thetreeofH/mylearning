...
import com.ts.spm.bizs.biz.stat.PassFlowBiz;
 ...
 */
@RestController
@RequestMapping("passnum")
@CheckClientToken
@CheckUserToken
@Api(tags = "客流管理")
public class PassnumController extends BaseController<PassFlowBiz, PassPersonCount, String> {
    ...
    public TableResultResponse passnumQuery(String departId,  String startTime, String endTime,
                                              @RequestParam(name = "limit", defaultValue = "10") int limit,
                                              @RequestParam(name = "page", defaultValue = "1") int page){

        List<String> pointIds = getUserPointId(departId);
        Page<Object> result = PageHelper.startPage(page, limit);
        List<Map> list=baseBiz.getPassList(pointIds,startTime,endTime);

        logBiz.saveLog("客流管理","客流查询", "api/stat/passnum/query");
    ...
    public ObjectRestResponse passnumStatisticsByTime(String departId,String timeType,String startTime,String endTime){
        ...
        logBiz.saveLog("客流管理","过包数统计（时间维度）", "api/stat/passnum/statisticsByTime");
    ...
    public ObjectRestResponse passnumStatisticsByHour(String departId,String startTime,String endTime){
        ...
        logBiz.saveLog("客流管理","过包数统计（小时维度）", "api/stat/passnum/statisticsByHour");
    ...
    public ObjectRestResponse passnumStatisticsByDepart(String departId,String startTime,String endTime,String departType){
...
//                statis.put("name",departCtr.getStationDetail(statis.get("departId")).get("name"));
        ...
        logBiz.saveLog("客流管理","过包数统计（部门维度）", "api/stat/passnum/statisticsByDepart");
    ...
    public TableResultResponse passnumList(String departId, String startTime, String endTime){
        List<PassPersonCount> list=baseBiz.passList(departId,startTime,endTime);

        logBiz.saveLog("客流管理","客流列表", "api/stat/passnum/list");
    ...
    @ResponseBody
    public void passnumExport(HttpServletResponse res, String departId, String startTime, String endTime){
        try {
            String colHeads[] = { "序号","车站","安检点","时间","向前人数","向后人数","报警人数","实际人数" };
            String keys[] = { "index","departName","pointName","countDate","incFcount","incBcount","incAcount","incCount" };
            List<String> pointIds = getUserPointId(departId);
            List<Map> list=baseBiz.getPassList(pointIds,startTime,endTime);
        ...
        logBiz.saveLog("客流管理","客流导出", "api/stat/passnum/export");
    }
